                                ...
                                @forelse ($contacts as $item)
                                    <tr>
                                        ...
                                        <td class="form-inline">
                                            <a class="btn btn-sm btn-info text-light" href="@route('admin.contact.show', $item->contact_id)"> <i
                                                    class="ri-eye-fill"></i></a>
                                            <a class="btn btn-sm btn-primary" href="@route('admin.contact.edit', $item->contact_id)"> <i
                                                    class="ri-edit-box-fill"></i></a>
                                            <form method="POST" action="@route('admin.contact.destroy',$item->contact_id)" class="mt-1">
                                                @csrf
                                                @method('Delete')
